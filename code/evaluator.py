...
if __name__ == '__main__':
    ...
    pred_path = "/scratch/project_2005072/keshu/cascade-camp-hands-on/code/output/Qwen/Qwen2.5-32B-Instruct_ner.json"
    output_path = "/scratch/project_2005072/keshu/cascade-camp-hands-on/code/output/Qwen/ner_f1_result.json"
